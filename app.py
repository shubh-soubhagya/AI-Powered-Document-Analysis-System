...
pdf_path = r"AI-Powered-Document-Analysis-System\data\pdf\legalimit.pdf"  # Update with actual PDF path
model_path = r"AI-Powered-Document-Analysis-System\model_training\trained_model"  # Update with actual model path
